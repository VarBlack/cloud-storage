...
// 抖函数
fq.shake = function (obj, attr, nums, fn){
  if(obj.shake) return;
  var arr = [], _this = this;
...
fq.setTransform = function (obj, attr, val){
...
// 碰撞检测函数
fq.duang = function (current, target){
...
// 鼠标滚轮事件
fq.wheelEvent = function (obj, fnUp, fnDown){
